...
pivotA <- magazinA %>% select(zi, Produs, Cerere) %>% pivot_wider(names_from = Produs, Values_from = Cerere, namesprefix = "Cerere")

corelatieProd <- cor(pivotA$Cerere_Produs_1, pivotA$Cerere_Produs_2)
